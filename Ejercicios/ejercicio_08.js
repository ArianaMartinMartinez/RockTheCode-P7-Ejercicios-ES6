...
const averageRpgGamesScore = rpgGames.reduce((acc, game) => acc + game.score, 0) / rpgGames.length;

console.log('Media de puntuación de los juegos RPG: ', averageRpgGamesScore);